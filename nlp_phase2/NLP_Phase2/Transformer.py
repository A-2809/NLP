...
model.save('/data3/nlp/akanksha_19022/akanksha_19022/MODEL/Transformer')

################# Step 6 - Use model to make predictions
print("")
print('-------------------- Predicting for test dataset--------------------')
model = models.load_model('/data3/nlp/akanksha_19022/akanksha_19022/MODEL/Transformer')
...
np.savetxt("testdata_classlabels_Transformer.csv", results, delimiter = ',', fmt="%s")
